...
int main() {
    ...
    while (t < tStop) {
        ...
        if (t==checkpointStep*checkpointi&&t!=tStop){
            string outfile1="/CFD_file/cylindricalEquilibrium/initialStates/tokamak_t";
    ...
    inteTotalEnergy.push_back(integratetotalenergy(u,uRigidBody));
    {
        ofstream outfile("/CFD_file/cylindricalEquilibrium/initialStates/tokamak_t.dat");
        if (!outfile)
            return -1;
    ...
    {
        ofstream outfile("/CFD_file/cylindricalEquilibrium/initialStates/integrated_totalEnergy.dat");
        if (!outfile)
            return -1;
