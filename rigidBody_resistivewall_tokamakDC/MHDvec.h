...
#define C_gamma 1.6667

class Equ{
public://For IdealMHD gamma=5/3
    double rho=0,momentum_x=0,momentum_y=0,momentum_z=0,energy=0,B_x=0,B_y=0,B_z=0,psi=0,n=9,
    ...
    Equ(double rt,double m_xt,double m_yt,double m_zt,double et,double bxt,double byt,double bzt): rho(rt), momentum_x(m_xt), momentum_y(m_yt),momentum_z(m_zt),energy(et),B_x(bxt),B_y(byt),B_z(bzt),n(8),gamma(C_gamma),psi(0){}
    void EoS(){
