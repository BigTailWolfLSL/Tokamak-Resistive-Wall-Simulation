...
\setbeamertemplate{headline}
{
  ...
  \begin{beamercolorbox}[wd=.285\paperwidth,ht=2.5cm,center,dp=1ex]{logo in
    head/foot}%
  \usebeamerfont{logo in head/foot}\includegraphics[width=.19\paperwidth]{./UClogo_bg.png}%
\end{beamercolorbox}%
...
\end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.225\paperwidth,ht=2.5cm,center,dp=1ex]{logo in
    head/foot}%
  \usebeamerfont{logo in head/foot}CDT in CMMS\vspace{0.5cm}%
\end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.225\paperwidth,ht=2.5cm,center,dp=1ex]{logo in
    head/foot}%
...
%% EDIT YOUR SUPERVISOR'S NAME BELOW %%
  \usebeamerfont{date in head/foot}{Supervisor: My Supervisor's
  Name}\vspace{0.3cm}
  \end{beamercolorbox}}%
\hskip0.015\paperwidth
  \vskip0.015\paperwidth%
